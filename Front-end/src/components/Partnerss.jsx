...
const Partners = [
  ...
  { name: "FIRETROL Company", img: شركه9 },
  { name: "LAPP Company", img: شركه10 },
  { name: "STATRON Company", img: شركه11 },
  { name: "ROVO Company", img: شركه12 },
  { name: "impa Company", img: شركه14 },
  { name: "KONGSBERG Company", img: شركه15 },
  { name: "RADIO HOLLAND Company", img: شركه16 },
  { name: "CREAFORM Company", img: شركه17 },
  { name: "blueye Company", img: شركه18 },
  { name: "MITSUBISHI ELETRIC Company", img: شركه19 },
  { name: "victron energy Company", img: شركه20 },
  { name: "JIULI ROPE Company", img: شركه21 },
  { name: "PAN AMERICAN Company", img: شركه22 },
];
